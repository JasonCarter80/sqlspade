 ...
 *		  Date: 12/3/2010
 * Description: Create the default sysadmin accounts
 *	   History: 12/3/2010 - Michael Wells - Adapted for Auto-Install
 *****************************************************************************************************/
 
use [master];
 
create login [alfki\SQL_DBA] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english];
EXEC master..sp_addsrvrolemember @loginame = N'alfki\SQL_DBA', @rolename = N'sysadmin';
