...
#Required Parameters
$ht.Add("DataCenter", 'Data Center 1')           #Must be setup in Data Center node of Config
...
$ht.Add("SysAdminPassword", 'SQL4tw!')           #Must be STRONG PASSWOD  TODO:  Test for Strong Password
